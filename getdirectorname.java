...
public class getdirectorname
    ...
    public void map(Object key, Text value, Context context)
        ...
        String[] crewline = line.split("\t");
        String crewname = crewline[1];
        String nconst = crewline[0];
        String crewdetails = "C" + ":" + crewname;
        context.write(new Text(nconst), new Text(crewdetails));
    }
}
